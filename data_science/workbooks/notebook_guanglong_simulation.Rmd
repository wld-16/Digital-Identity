...
plot(normalizedOrientationState$w[1:simulatedMax] ~ sim_time, pch  = 20, main = "q_w state", ylab = "value normalized", xlab="time in seconds", type='l', ylim=c(
...
legend("bottomright", legend = c("q_w state", "process uncertainty"), lwd = 3, col = c("blue", "lightsteelblue"))


plot(normalizedOrientationState$x[1:simulatedMax] ~ sim_time, pch  = 20, main = "q_x state", ylab = "value normalized", xlab="time in seconds", type='l', ylim=c(
...
legend("bottomright", legend = c("q_x state", "process uncertainty"), lwd = 3, col = c("blue", "lightsteelblue"))

plot(normalizedOrientationState$y[1:simulatedMax] ~ sim_time, pch  = 20, main = "q_y state", ylab = "value normalized", xlab="time in seconds", type='l', ylim=c(
...
legend("bottomright", legend = c("q_y state", "process uncertainty"), lwd = 3, col = c("blue", "lightsteelblue"))

plot(normalizedOrientationState$z[1:simulatedMax] ~ sim_time, pch  = 20, main = "q_z state", ylab = "value normalized", xlab="time in seconds", type='l', ylim=c(
...
legend("bottomright", legend = c("q_z state", "process uncertainty"), lwd = 3, col = c("blue", "lightsteelblue"))

plot(simulationOrientationMeasurementsAsMatrix[1,] ~ sim_time, pch  = 20, main = "v_x in simulation", ylab = "v_x", xlab="time in seconds", type='l', ylim=c(
...
legend("bottomright", legend = c("v_x state", "simulated vx", "process uncertainty"), lwd = 3, col = c("blue", "black", "lightsteelblue"))

plot(simulationOrientationMeasurementsAsMatrix[2,] ~ sim_time, pch  = 20, main = "v_y in simulation", ylab = "v_y", xlab="time in seconds", type='l', ylim=c(
...
plot(simulationOrientationMeasurementsAsMatrix[3,] ~ sim_time, pch  = 20, main = "v_z in simulation", ylab = "v_z", xlab="time in seconds", type='l', ylim=c(
...
plot(simulationAccelerationMeasurementsAsMatrix[1,] ~ sim_time, pch  = 20, main = "p_x in simulation", ylab = "p_x", xlab="time in seconds", type='l', ylim=c(
...
legend("bottomright", legend = c("p_x state", "simulated px", "process uncertainty"), lwd = 3, col = c("blue", "black", "lightsteelblue"))

plot(simulatedfkfGuanglongAccelerationModel$att[2,1:simulatedMax] ~ sim_time, pch  = 20, main = "v_x in simulation", ylab = "v_x",xlab="time in seconds", type='l', ylim=c(
...
legend("bottomright", legend = c("v_y state", "process uncertainty"), lwd = 3, col = c("blue", "lightsteelblue"))

plot(simulationAccelerationMeasurementsAsMatrix[2,] ~ sim_time, pch  = 20, main = "a_x in simulation", ylab = "a_x", xlab="time", type='l', ylim=c(
...
legend("bottomright", legend = c("a_x state", "simulated ax", "process uncertainty"), lwd = 3, col = c("blue", "black", "lightsteelblue"))

plot(simulationAccelerationMeasurementsAsMatrix[3,] ~ sim_time, pch  = 20, main = "p_y in simulation", ylab = "p_y",xlab="time in seconds", type='l', ylim=c(
...
legend("bottomright", legend = c("p_y state", "simulated py", "process uncertainty"), lwd = 3, col = c("blue", "black", "lightsteelblue"))


plot(simulatedfkfGuanglongAccelerationModel$att[5,1:simulatedMax] ~ sim_time, pch  = 20, main = "v_y in simulation", ylab = "v_z",xlab="time in seconds", type='l', ylim=c(
...
plot(simulationAccelerationMeasurementsAsMatrix[4,] ~ sim_time, pch  = 20, main = "a_y in simulation", ylab = "a_y",xlab="time in seconds", type='l', ylim=c(
